function components() {
    ...
    let footer = `
        <div id="footer">
            <div id="separator">
                <p class="normal-text" id="separator-text">ACCESSIBLE BOLD EMPATHETIC STUDENT DESIGNER DEVELOPER ACCESSIBLE BOLD EMPATHETIC STUDENT DESIGNER DEVELOPER ACCESSIBLE BOLD EMPATHETIC STUDENT DESIGNER DEVELOPER ACCESSIBLE BOLD EMPATHETIC STUDENT DESIGNER DEVELOPER ACCESSIBLE BOLD EMPATHETIC STUDENT DESIGNER DEVELOPER ACCESSIBLE BOLD EMPATHETIC STUDENT DESIGNER DEVELOPER ACCESSIBLE BOLD EMPATHETIC STUDENT DESIGNER DEVELOPER ACCESSIBLE BOLD EMPATHETIC STUDENT DESIGNER DEVELOPER </p>
            </div>
            <div id="footer-main">
